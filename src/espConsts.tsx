...
type LDMDataType = {
  ...
  readonly DHT_CHARACTERISTIC: string;
  readonly BME680_CHARACTERISTIC: string;
}
...
export const LDMData: LDMDataType = {
  ...
  DHT_CHARACTERISTIC: "00004d03-0000-1000-8000-00805f9b34fb",
  BME680_CHARACTERISTIC: "00004d04-0000-1000-8000-00805f9b34fb"
}
